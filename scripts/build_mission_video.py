...
SOURCE_DIR = (
    ROOT / "mission-extracted_frames_60fps" / "mission-extracted_frames_60fps"
)
OUTPUT_DIR = ROOT / "assets" / "mission"

SOURCE_FRAME_RATE = 60
OUTPUT_FRAME_RATE = 60
SLOW_FRAMERATE = 10
VIDEO_BASENAME = "mission-background"
...
def export_frames(frame_paths: list[Path]) -> Path:
    ...
    poster.save(OUTPUT_DIR / "mission-poster.jpg", quality=92, optimize=True)
...
def main() -> None:
    ...
    print(f"Built mission assets in {OUTPUT_DIR}")
